...
import { StatusConta } from '../../shared/models/status-conta.model';
...
export class MockDataService {
  ...
  private readonly statusPadrao = new StatusConta(true, null, new Date());

  private readonly cliente1 = new Cliente(1, "Catharyna", "cli1@bantads.com.br", "12912861012", this.endereco1, "4199999999", 10000.00, this.statusPadrao);
  private readonly cliente2 = new Cliente(2, "Cleuddônio", "cli2@bantads.com.br", "09506382000", this.endereco2, "4498888888", 20000.00, this.statusPadrao);
  private readonly cliente3 = new Cliente(3, "Catianna", "cli3@bantads.com.br", "85733854057", this.endereco3, "47977777777", 3000.00, this.statusPadrao);
  private readonly cliente4 = new Cliente(4, "Cutardo", "cli4@bantads.com.br", "58872160006", this.endereco2, "4998000000", 500.00, this.statusPadrao);
  private readonly cliente5 = new Cliente(5, "Coândrya", "cli5@bantads.com.br", "76179646090", this.endereco1, "49989896976", 1500.00, this.statusPadrao);
  ...
  private readonly admin = new Admin(4, "Adamântio", "adm1@bantads.com.br", "40501740066");

  private readonly auth1 = new User(TipoUsuario.CLIENTE, "cli1@bantads.com.br", "tads", "1");
  private readonly auth2 = new User(TipoUsuario.CLIENTE, "cli2@bantads.com.br", "tads", "2");
  private readonly auth3 = new User(TipoUsuario.CLIENTE, "cli3@bantads.com.br", "tads", "3");
  private readonly auth4 = new User(TipoUsuario.CLIENTE, "cli4@bantads.com.br", "tads", "4");
  private readonly auth5 = new User(TipoUsuario.CLIENTE, "cli5@bantads.com.br", "tads", "5");
  ...
  public loadMockData(): void {
    ...
    if (!localStorage.getItem('users')) {
      localStorage.setItem('users', JSON.stringify(mockAuth));
    }
  }
}
