...
public class DataLoader implements CommandLineRunner{
    ...
    public void run(String... args) throws Exception {
        ...
        if (contaWriteRepository.count() > 0) {
            log.info("O banco de dados de escrita já está populado. Ignorando data loader.");
            return;
        }

        log.info("Executando carga inicial de dados (Data Loader)...");
